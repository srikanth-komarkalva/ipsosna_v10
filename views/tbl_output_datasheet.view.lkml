...
#Significance Filter
  ...
  measure: Weighted_Pct_Line_rank_brand {
    ...
    <div> Rank: <p style="color: white; font-size:100%; text-align:center">{{rank_brand_label._value}}</p></div>
  ...
  measure: Weighted_Pct_Line_rank_brand_agg {
    label: "Weighted %"
    group_label: "For Developers"
    description: "Weighted % for Trend chart with Rank by Brand calc"
    type: number
    value_format_name: percent_0
    # sql: ${wt_percent} ;;
    sql:  ${wt_count}/NULLIF(round(${wt_base}),0) ;;
    ...
    <div>Rank: <p style="color: white; font-size:100%; text-align:center"></p></div>
    {% endif %}

    ;;
  }

  measure: Weighted_Pct_Line_rank_brand_1 {
    label: "Weighted %"
    group_label: "For Developers"
    description: "Weighted % without rank"
    type: number
    value_format_name: percent_0
    sql: ${wt_count}/NULLIF(round(${wt_base}),0) ;;
    html:
